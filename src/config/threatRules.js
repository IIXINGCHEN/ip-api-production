...
export const THREAT_RULES = {
  ...
  knownVPNRanges: {
    ipv4: [
      "185.220.100.",
      "185.220.101.",
      "185.220.102.", // Tor/VPN exits
      "198.98.50.",
      "198.98.51.",
      "198.98.52.", // VPN providers
      "46.166.160.",
      "46.166.161.", // Specific VPN ranges
  ...
  datacenterRanges: {
    ipv4: [
      ...
      "52.0.",
      "52.1.",
      "52.2.", // AWS VPN-specific
      "35.0.",
      "35.1.",
      "35.2.", // Google Cloud VPN-specific
      "40.0.",
      "40.1.",
      "40.2.", // Azure VPN-specific
    ],
  },
  ...
  legitimateServices: {
    ipv4: [
      ...
      "52.",
      "54.", // AWS (broad ranges for legitimate services)
      "35.",
      "34.", // Google Cloud
      "40.",
      "13.", // Azure
